  ...
  return (
    <div className='px-44'>
      ...
      <p className='text-right text-5xl'>
        <br />
        <a target="_blank" href="https://github.com/athena1304" className='hover:drop-shadow-md hover:text-purple'><i class="fa-brands fa-github"></i></a>&nbsp;&nbsp;&nbsp;
        <a target="_blank" href="https://www.linkedin.com/in/ankit-jha-55353021b/" className='hover:drop-shadow-md hover:text-metal'><i class="fa-brands fa-linkedin"></i> </a>&nbsp;&nbsp;
      </p>
    </div>
  )
}
